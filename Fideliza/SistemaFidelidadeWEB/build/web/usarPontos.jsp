...
<table width="982" height="245" border="0" align="center">
  <tr>
    ...
    <td width="772"><table width="392" border="0" align="center">
      <tr>
        <td bgcolor="#c2ccff"><strong>Usar pontos</strong></td>
      </tr>
    </table>
    <form name="usarPontos" action="usarPontosOP.jsp" method="get">
      ...
      <table width="393" border="0" align="center">
        <tr>
          <td align="center">
          <input name="crud" type="submit" value="Usar pontos" size="30"/>
          </td>
        </tr>
    </table>
   </form>
